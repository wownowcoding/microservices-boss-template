          ...
          <div class="form-con">
            <Form ref="form" :model="form" :rules="rules" @submit.native.prevent>
              ...
              <FormItem prop="password">
                <Input
                  ...
                  :icon="showPwd ? 'ios-eye' : 'ios-eye-off'"
            ...
            <div class="tips">
              ...
              <div
                ...
                @click="goUpload"
                v-if="['sit', 'uat', 'local'].indexOf(deployEnv) !== -1"
              >
        ...
        <div v-else class="card card_google">
          ...
          <Form ref="googleForm" :model="googleForm" :rules="googleRules" @submit.native.prevent>
            <FormItem prop="google_code">
              <Input
                type="text"
                v-model="googleForm.google_code"
                autofocus
                :placeholder="$t('part_second.google_code')"
              />
            </FormItem>
            <FormItem>
