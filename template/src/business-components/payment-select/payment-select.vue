<template>
  <Modal v-model="visible" :title="$t('v3_1_1.configurePaymentVouche')" width="88vw" class="coupons-select">
...
export default {
  ...
  data() {
    return {
      ...
      queryList: [
        {
          type: 'text',
          label: this.$t('couponTrack.PaymentVoucherID'),
          key: 'couponNo'
        },
        {
          type: 'text',
          label: this.$t('v4_1_1.PaymentVoucherName'),
          key: 'couponName'
        }
        // {
        //   type: 'select',
      ...
      table: {
        ...
        cols: [
          ...
          {
            title: this.$t('couponTrack.PaymentVoucherID'),
            minWidth: 180,
            align: 'center',
            key: 'couponNo'
          },
          {
            title: this.$t('v4_1_1.PaymentVoucherName'),
            minWidth: 110,
            align: 'center',
            key: 'couponName'
          },
          ...
          // },
          {
            title: this.$t('v1.PaymentVoucherQuota'),
            minWidth: 100,
            align: 'center',
            key: 'reduceAmountUsd',
            render: (h, { row }) => {
  ...
  methods: {
    ...
    async ajaxQueryList(params = {}) {
      ...
      let { rspCd, data } = await wownowCouponList({ ...params, couponType: 37 })
