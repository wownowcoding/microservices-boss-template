...
import Focus from '@/mixin/common/focus';
import RepeatClick from '@/directives/repeat-click';
import './index.css';
import Emitter from '@/mixin/common/emitter.js';
...
export default {
  ...
  methods: {
    ...
    handleBlur(event) {
      ...
      this.dispatch('FormItem', 'on-form-blur', this.currentInputValue);
    },
    handleFocus(event) {
    ...
    setCurrentValue(newVal) {
      ...
      this.dispatch('FormItem', 'on-form-change', this.currentInputValue);
      this.currentValue = newVal;
    },
