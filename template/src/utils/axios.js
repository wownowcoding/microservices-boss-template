...
let ex_post_func;
let ex_mock_func;
let ex_mock_func_hbf;
let ex_errorManage;
let ex_rspInfManage;
let ex_post_funcCallback;
let ex_get_upload_url;
let ex_jsCrypto;

if (window.boss_axios) {
	ex_base_api = window.boss_axios.base_api
	ex_post_func = window.boss_axios.post_func
	ex_mock_func = window.boss_axios.mock_func
	ex_mock_func_hbf = window.boss_axios.mock_func_hbf
	ex_errorManage = window.boss_axios.errorManage
	ex_rspInfManage = window.boss_axios.rspInfManage
	ex_post_funcCallback = window.boss_axios.post_funcCallback
	ex_get_upload_url = window.boss_axios.get_upload_url
	ex_jsCrypto = window.boss_axios.jsCrypto
} else {
	...
	ex_base_api = base_api
	ex_post_func = post_func
	ex_mock_func = mock_func
	ex_mock_func_hbf = mock_func_hbf
	ex_errorManage = errorManage
	ex_rspInfManage = rspInfManage
	ex_post_funcCallback = post_funcCallback
	ex_get_upload_url = get_upload_url
	ex_jsCrypto = jsCrypto
}

export const base_api = ex_base_api
export const post_func = ex_post_func
export const mock_func = ex_mock_func
export const mock_func_hbf = ex_mock_func_hbf
export const errorManage = ex_errorManage
export const rspInfManage = ex_rspInfManage
export const post_funcCallback = ex_post_funcCallback
export const get_upload_url = ex_get_upload_url
export const jsCrypto = ex_jsCrypto